...
// Procesamiento del formulario PHP para insertar un nuevo tipo de producto
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Insertar un nuevo registro en la tabla Tipos_Productos
        $sql = "INSERT INTO Tipos_Productos (descripcion) VALUES (:descripcion)";
    ...
    <div class="container mt-5">
        <div class="card shadow-lg">
            <div class="card-header bg-success text-white">
                <h2 class="mb-0">Agregar Nuevo Tipo de Producto</h2>
            </div>
            <div class="card-body">
                <?php if (isset($error)): ?>
